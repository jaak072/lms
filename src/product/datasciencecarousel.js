...
class Datasciencecarousel extends Component {
    state = { 
      responsive: {
        0: { 
          items: 1
            ...
            <div className="border-10 p-3">
                <div className="container">
                    ...
                    <div className='col-md-7'>
                        ...
                        <p className="block-ellipsis">Data science is everywhere. Better data science practices are allowing corporations to cut unnecessary costs, automate computing, and analyze markets. Essentially, data science is the key to getting ahead in a competitive global climate.</p>
                        <button type="button" class="btn btn-outline-info">Explore Data Science</button>
                    </div>
